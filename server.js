...
const run = async () => {
  ...
  console.log(
    ">> Domicilio id=" + dom1Data.id,
    JSON.stringify(dom1Data, null, 2)
  );

  const dom2Data = await controllerDomicilio.findDomicilioById(dom2.id);
  console.log(
    ">> Domicilio id=" + dom2Data.id,
    JSON.stringify(dom2Data, null, 2)
  );
  ...
  console.log(
    ">> Persona id=" + persona1.id,
    JSON.stringify(persona1Data, null, 2)
  );

  const persona2Data = await controllerPersona.findPersonaById(persona2.id);
  console.log(
    ">> Persona id=" + persona2.id,
    JSON.stringify(persona2Data, null, 2)
  );
